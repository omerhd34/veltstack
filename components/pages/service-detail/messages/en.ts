    ...
    features: [
      {
        ...
        description:
          "Analysis of site speed, crawl errors, indexing and structured data.",
      },
      {
        title: "Keyword Strategy",
        description:
          "Keyword map aligned with your audience and conversion potential.",
      },
      {
        title: "On-Page Optimization",
        description:
          "Improvements to heading structure, meta tags, internal links and content layout.",
      },
      {
        title: "Content Planning",
        description:
          "SEO-friendly editorial calendar for blog and landing page content.",
      },
      {
        title: "Performance Monitoring",
        description:
          "Ranking, traffic and conversion tracking via Search Console and Analytics.",
      },
      {
