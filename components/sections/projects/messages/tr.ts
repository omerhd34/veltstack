export const projectsHomeTr = {
  ...
  projectsTitleLead: "Gerçek iş hedeflerine hizmet eden",
  ...
  projectFablessiDesc:
    "Bahçe ve balkon mobilyaları için premium kurumsal ürün vitrini. Zengin görsel sunum, net kategori yapısı ve marka algısını güçlendiren modern bir katalog deneyimi.",
  projectFablessiTag: "Kurumsal - Katalog",
  projectUzmanPsikologTitle: "Uzman Klinik Psikolog Web Sitesi",
  projectUzmanPsikologDesc:
    "Uzman Klinik Psikolog Nisa Demir için geliştirilen profesyonel web platformu. RESTful API ile randevu talebi, içerik ve iletişim süreçleri; SEO optimizasyonu ve dinamik içerik yönetimi.",
